...
#ifndef DOGLENS_SWIFT_H
#define DOGLENS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DogLens",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7DogLens20CameraViewController")
...
- (void)handlePinch:(UIPinchGestureRecognizer * _Nonnull)gesture;
- (void)handleTapFocus:(UITapGestureRecognizer * _Nonnull)gesture;
- (void)handleLongPressFocus:(UILongPressGestureRecognizer * _Nonnull)gesture;
- (void)capturePhoto;
- (void)closeCamera;
...
@interface CameraViewController (SWIFT_EXTENSION(DogLens)) <AVCapturePhotoCaptureDelegate>
...
SWIFT_CLASS("_TtC7DogLens24LiveCameraViewController")
...
@interface LiveCameraViewController (SWIFT_EXTENSION(DogLens)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

SWIFT_CLASS("_TtC7DogLens25VideoCameraViewController")
...
@class NSURL;
@interface VideoCameraViewController (SWIFT_EXTENSION(DogLens)) <AVCaptureFileOutputRecordingDelegate>
